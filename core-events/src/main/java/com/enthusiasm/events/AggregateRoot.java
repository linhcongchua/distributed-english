...
import com.enthusiasm.events.exceptions.InvalidEventException;
import lombok.Data;
...
public abstract class AggregateRoot {
    ...
    public AggregateRoot(String id, String aggregateType) {
        this.id = id;
    ...
    private void validateEvent(final Event event) {
        if (Objects.isNull(event) || !Objects.equals(event.getAggregateId(), this.id)) {
